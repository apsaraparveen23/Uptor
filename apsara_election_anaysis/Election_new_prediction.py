...
def run_pipeline():
    ...
    new_tweets = pd.DataFrame({
        'tweet': [
            "Modi's speech was inspiring and full of hope.",
            "Congress criticized the new budget proposal.",
            "The rally was huge but lacked clear messaging."
        ]
    })
